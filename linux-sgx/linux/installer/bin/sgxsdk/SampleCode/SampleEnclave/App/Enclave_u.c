...
static sgx_status_t SGX_CDECL Enclave_ocall_test_null(void* pms)
{
...
sgx_status_t ecall_test_null(sgx_enclave_id_t eid)
{
	sgx_status_t status;
...
sgx_status_t ocall_test_null_wrapper(sgx_enclave_id_t eid, int n)
{
	sgx_status_t status;
	ms_ocall_test_null_wrapper_t ms;
	ms.ms_n = n;
